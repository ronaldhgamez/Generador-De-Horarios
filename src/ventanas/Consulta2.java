...
public class Consulta2 extends javax.swing.JPanel {
    ...
    private void mostrarHorario2() {
        jLabelNumero.setText((indice +1 ) + "");
        limpiarTextFields();
        ArrayList<String[]> solucion = horarios.get(indice);
        
        String dia, horaIni, horaFin, idCurso, cedula, color;
        Profesor p;
        Curso c;
    ...
    private void jButtonConsulta2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsulta2ActionPerformed
        ...
        horarios = pr.prolog.consulta2Y5(semestre, totCom, 2);
        indice = 0;
        jLabelNumero.setText((indice + 1) + "");
        if(horarios != null) {
            mostrarHorario2();
