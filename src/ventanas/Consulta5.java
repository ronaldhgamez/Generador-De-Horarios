...
public class Consulta5 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Combinaciones");
        add(jLabel3);
        jLabel3.setBounds(90, 90, 100, 14);
        ...
        add(jTextFieldCombinaciones);
        jTextFieldCombinaciones.setBounds(190, 80, 80, 30);
        ...
        add(jTextFieldSemestre);
        jTextFieldSemestre.setBounds(190, 40, 80, 30);
        ...
        jLabel4.setText("    Horarios generados");
        jLabel4.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        add(jLabel4);
        jLabel4.setBounds(770, 10, 170, 30);
    ...
    private void jButtonConsulta5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsulta5ActionPerformed
        ...
        try{
            ...
            totCom = Integer.parseInt(jTextFieldCombinaciones.getText());
        ...
        horarios = pr.prolog.consulta2Y5(semestre, totCom, 5);
        indice = 0;
    ...
    private void jButtonAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnteriorActionPerformed
        indice--;
        jLabelNumero.setText((indice +1 ) + "");
        //System.out.println("Muestra objeto en la posición: " + indice);
        mostrarHorario5();
    ...
    private void jButtonSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSiguienteActionPerformed
        ...
        System.out.println(horarios.size() - 1);
    ...
    private void mostrarHorario5() {
        limpiarTextFields();
        ArrayList<String[]> solucion = horarios.get(indice);
        
        String dia, horaIni, horaFin, idCurso, cedula, idAula, color;
        Profesor p;
        Curso c;
        Aula a;
        ...
        for (String[] array : solucion) {
            ...
            horaIni = array[1]; // HORA INICIO
            horaFin = array[2]; // HORA FINAL
            idCurso = array[3].replace("'", ""); // ID CURSO
            cedula  = array[4].replace("'", ""); // CEDULA PROFESOR
            idAula  = array[5].replace("'", ""); // ID AULA
            color   = array[6];
            
            c = listas.buscarCurso(idCurso);
            p = listas.buscarProfesor(cedula);
            a = listas.buscarAula(idAula);
            
            String text = c.getNombre() + "\n" + p.getNombre() + "\n" + a.getIdAula();
